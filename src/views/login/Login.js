                ...
                <View style={styles.container}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.title}>
                            <Text style={{ color: '#FFC0CB', fontSize: 50 }}>Login</Text>
                        </Text>
                    </View>

                    <View style={styles.form}>
                        <View style={styles.input}>
                            <Text style={styles.inputLabel}>Use Name</Text>
                            <TextInput
                                autoCapitalize="none"
                                autoCorrect={false}
                                ...
                                placeholder="Điền phải có @gmail.com"
                        ...
                        <Text style={styles.formLink}>Miss Password?</Text>
                    </View>
                </View>
            </KeyboardAwareScrollView>
